    ...
    <>
        ...
        <div className="group flex flex-wrap gap-4 mt-4 w-max">
          {nowPlayingMovies.map((movie) =>(
            <div key={movie.id} className={`relative max-w-40 cursor-pointer
              group-hover:not-hover:opacity-40 hover:-translate-y-1 transition duration-300`} onClick={() => setSelectedMovies(movie.id)}>
      ...
      <div className="mt-8">
          ...
          px-3 py-2 rounded-md">
            ...
            placeholder='Enters show price' className='outline-none'/>
          </div>
      </div>
      ...
      <button  disabled={addingShow} className="bg-primary text-white px-8 py-2 mt-6 rounded 
