...
const SeatLayout = () => {
  ...
  const getOccupiedSeats = async ()=>{
    try{
      if (!selectedTime || !selectedTime.showId) {
            console.warn("selectedTime or selectedTime.showId is undefined.  Skipping API call.");
            return; 
      }
  ...
  if (selectedTime?.showId) {
    ...
    console.log("selectedTime or selectedTime.showId is undefined. Skipping API call.");
  }
}, [selectedTime]);
  ...
  return show ? (
    <div className='flex flex-col md:flex-row px-6 md:px-16 lg:px-40 py-30 md:pt-50'>
      ...
      <div className='relative flex-1 flex flex-col items-center max-md:mt-16'>    
        ...
        <p className='text-gray-400 text-sm mb-16'>SCREEN SIDE</p>
